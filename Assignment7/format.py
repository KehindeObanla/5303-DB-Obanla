...
f = open('/var/www/html/Database/Assignment7/summer2_2021.json')
...
for i in data:
    ...
    if('-' in dic['Crn'] or dic['Crn'] == '' ):
        ...
        sql ="INSERT INTO `CourseInfo` (`Col`, `Crn`, `Subj`, `Crse`, `Sect`, `Title`, `PrimaryInstructor`, `Max`, `Curr`, `Aval`, `Days`, `Begin`, `End`, `Bldg`, `Room`, `year`, `Season`) VALUES ('{Col}', '{Crn}','{Subj}', '{Crse}','{Sect}','{Title}','{PrimaryInstructor}', '{Max}', '{Curr}', '{Aval}', '{Days}', '{Begin}', '{End}', '{Bldg}', '{Room}', '2021', 'Summer2');".format(**coursedic)
        cnx.query(sql)
print(len(data))
print(len(test))
print(count)
