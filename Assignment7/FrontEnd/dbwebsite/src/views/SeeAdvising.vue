<template>
  ...
  <form v-on:submit.prevent="Seeform" class="SeeAdvisng">
    <div>
      ...
      />&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; Major<input
        type="text"
        list="Major"
        v-model="tosend.Major"
      />
      <datalist name="Major" id="Major">
        <option v-for="item in Majors" :key="item" :value="item" /></datalist
      >&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; Classification
      <select
        name="Classification"
        id="Classification"
...
export default {
  ...
  methods: {
    Seeform() {
      ...
      axios
        .post(
          "http://143.244.153.25:8004/Advising/All",
